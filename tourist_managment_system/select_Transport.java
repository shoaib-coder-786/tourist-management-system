...
public class select_Transport extends JFrame implements Runnable{
    Thread t1;
    ...
    public void run(){ try{for(int i = 0;i<=9;i++){
        String[] text =new String[]{"THAR","CAR","FARARI","BUS","luxary bus", "vanaty vein","SUPER BIKE","Auto","SCOOTER","HELICOPTER"};
...
for(int i = 0; i<=9;i++){
    image[i] = new ImageIcon(ClassLoader.getSystemResource("tourist_managment_system/icons/car"+(i+1)+".jpg"));
