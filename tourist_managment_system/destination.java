...
public class destination extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){ try{for(int i = 0;i<=9;i++){
        String[] text =new String[]{"BOOK YOUR  DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION", "BOOK YOUR DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION","BOOK YOUR DESTINATION"};
...
for(int i = 0; i<=9;i++){
    image[i] = new ImageIcon(ClassLoader.getSystemResource("tourist_managment_system/icons/dest"+(i+1)+".jpg"));
